...
//         public async Task<IActionResult> Create([Bind("Id,Naam,Reden")] ReportModel reportModel)
//         {
...
//         [HttpPost]
//         [ValidateAntiForgeryToken]
//         public async Task<IActionResult> Edit(int id, [Bind("Id,Naam,Reden")] ReportModel reportModel)
//         {
...
//         {
//             return _context.ReportModel.Any(e => e.Id == id);
//         }
//     }
// }
