...
export default function () {
  const BASE_URL = 'https://localhost:5001'; // make sure this is not production

  const responses = http.batch([
    ['GET', `${BASE_URL}/Specialisten/Bert`],
    ['GET', `${BASE_URL}/Specialisten/Sara`],
    ['GET', `${BASE_URL}/Specialisten/Karel`],
    ['GET', `${BASE_URL}/Specialisten/Jojan`],
  ]);
